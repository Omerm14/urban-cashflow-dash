        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <a href={url} target="_blank" rel="noreferrer"
              style={{ padding: "6px 12px", background: "var(--surf2)", border: "1px solid var(--bdr)",
                borderRadius: 8, color: "var(--t2)", fontSize: 12, textDecoration: "none", fontFamily: "inherit" }}>
              Open in new tab ↗
            </a>
            <button onClick={onClose}
              style={{ width: 30, height: 30, borderRadius: 8, background: "var(--surf2)", border: "1px solid var(--bdr)",
