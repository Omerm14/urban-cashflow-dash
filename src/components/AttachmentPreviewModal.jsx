  ...
  return (
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}
      ...
      <div style={{
        ...
        boxShadow: "0 25px 60px rgba(0,0,0,.6)", display: "flex", flexDirection: "column", overflow: "hidden",
      }}>
        <div style={{
          display: "flex", alignItems: "center", justifyContent: "space-between",
          padding: "14px 20px", borderBottom: "1px solid var(--bdr)", flexShrink: 0,
        }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <a href={url} target="_blank" rel="noreferrer"
              style={{ padding: "6px 12px", background: "var(--surf2)", border: "1px solid var(--bdr2)",
                borderRadius: 8, color: "var(--t2)", fontSize: 12, textDecoration: "none", fontFamily: "inherit" }}>
              Open in new tab ↗
            </a>
            <button onClick={onClose}
              style={{ width: 30, height: 30, borderRadius: 8, background: "var(--surf2)", border: "1px solid var(--bdr2)",
